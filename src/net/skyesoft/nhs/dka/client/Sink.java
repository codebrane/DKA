...
public abstract class Sink extends Composite {
  /** Used to communicate the current Study No between the pages */
  protected static String studyNo = null;

  // Used for loading existing data from the database
  final ListBox lbStudyNos = new ListBox();
  ...
  public void save() {}
  public String getStudyNo() { return "NOT_SUPPORTED"; }
}
